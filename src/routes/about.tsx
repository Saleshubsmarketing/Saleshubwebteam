...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — SaleshubsWebOffice eCommerce Growth Agency" },
...
function AboutPage() {
  return (
    <SiteLayout>
      <PageHero eyebrow="About us" title={<>Built by operators. <span className="text-gradient">For operators.</span></>} subtitle="SaleshubsWebOffice is a remote, senior team of Shopify Plus designers, CRO strategists, email architects, paid ads buyers and SEO engineers." />
