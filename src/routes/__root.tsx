...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SaleshubsWebOffice — Elite Shopify Growth Agency" },
      { name: "description", content: "Premium design, CRO, SEO, email and paid ad systems engineered to scale Shopify brands." },
      { name: "author", content: "SaleshubsWebOffice" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { property: "og:title", content: "SaleshubsWebOffice — Elite Shopify Growth Agency" },
      { name: "twitter:title", content: "SaleshubsWebOffice — Elite Shopify Growth Agency" },
    ...
    scripts: [
      {
        children: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-T9SP2JHT');`,
      },
    ],
  }),
  ...
  return (
    <html lang="en">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-T9SP2JHT"
            height="0"
            width="0"
